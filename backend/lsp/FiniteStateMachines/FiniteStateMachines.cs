...
namespace FiniteStateMachinesToPetriNets.FiniteStateMachines
{
    ...
    /// <summary>
    /// Denotes a class capable to parse the language finite-state-machines
    /// </summary>
    public partial class FiniteStateMachinesGrammar : ReflectiveGrammar
    {
        ...
        public partial class StateRule : ModelElementRule<State>
        {
            ...
            {
                Rules = new FormattedRule[] {
                        RuleFormatter.ZeroOrOne(context.ResolveFormattedRule<StateIsFinalRule>()),
                        RuleFormatter.ZeroOrOne(context.ResolveFormattedRule<StateIsInitialRule>()),
                        context.ResolveKeyword("state"),
                        context.ResolveFormattedRule<StateNameIdentifierRule>(FormattingInstruction.Newline)};
                RegisterFeature(0, "isFinal");
                RegisterFeature(1, "isInitial");
        ...
        /// <summary>
        /// Rule to assign the contents of the inner rule to isInitial
        /// </summary>
        public partial class StateIsInitialRule : ExistsAssignRule<IState>
        {
            ...
            public override void Initialize(GrammarContext context)
            {
                Inner = context.ResolveKeyword("initial");
            }
            ...
            {
                return semanticElement.IsInitial;
            }
            ...
            {
                semanticElement.IsInitial = propertyValue;
            }
        }
        ...
        /// </summary>
        public partial class StateIsFinalRule : ExistsAssignRule<IState>
        {
