...
namespace FiniteStateMachinesToPetriNets.FiniteStateMachines
{
    ...
    [XmlNamespaceAttribute("anytext:finite-state-machines")]
    [XmlNamespacePrefixAttribute("finite-state-machines")]
    [ModelRepresentationClassAttribute("anytext:finite-state-machines#//StateMachine")]
    ...
    public partial class StateMachine : ModelElement, IStateMachine, IModelElement
    {
        ...
        [ConstantAttribute()]
        public IListExpression<ITransition> Transitions
        {
            get
            {
        ...
        [ContainmentAttribute()]
        [ConstantAttribute()]
        public IListExpression<IState> States
        {
            get
            {
                return this._states;
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("anytext:finite-state-machines#//StateMachine")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(FiniteStateMachinesToPetriNets.FiniteStateMachines.StateMachine.ClassInstance)).Resolve("id")));
        }
        
        private static ITypedElement RetrieveTransitionsReference()
        {
            return ((ITypedElement)(((ModelElement)(FiniteStateMachinesToPetriNets.FiniteStateMachines.StateMachine.ClassInstance)).Resolve("transitions")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(FiniteStateMachinesToPetriNets.FiniteStateMachines.StateMachine.ClassInstance)).Resolve("states")));
        }
    ...
    [XmlNamespaceAttribute("anytext:finite-state-machines")]
    [XmlNamespacePrefixAttribute("finite-state-machines")]
    [ModelRepresentationClassAttribute("anytext:finite-state-machines#//State")]
    ...
    public partial class State : ModelElement, IState, IModelElement
    {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                if ((_classInstance == null))
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("anytext:finite-state-machines#//State")));
                }
                return _classInstance;
            }
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(FiniteStateMachinesToPetriNets.FiniteStateMachines.State.ClassInstance)).Resolve("name")));
        }
        
        private static ITypedElement RetrieveIsInitialAttribute()
        {
            return ((ITypedElement)(((ModelElement)(FiniteStateMachinesToPetriNets.FiniteStateMachines.State.ClassInstance)).Resolve("isInitial")));
        }
        
        private static ITypedElement RetrieveIsFinalAttribute()
        {
            return ((ITypedElement)(((ModelElement)(FiniteStateMachinesToPetriNets.FiniteStateMachines.State.ClassInstance)).Resolve("isFinal")));
        }
    ...
    [XmlNamespaceAttribute("anytext:finite-state-machines")]
    [XmlNamespacePrefixAttribute("finite-state-machines")]
    [ModelRepresentationClassAttribute("anytext:finite-state-machines#//Transition")]
    public partial class Transition : ModelElement, ITransition, IModelElement
    {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                if ((_classInstance == null))
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("anytext:finite-state-machines#//Transition")));
                }
                return _classInstance;
            }
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(FiniteStateMachinesToPetriNets.FiniteStateMachines.Transition.ClassInstance)).Resolve("input")));
        }
        
        private static ITypedElement RetrieveEndStateReference()
        {
            return ((ITypedElement)(((ModelElement)(FiniteStateMachinesToPetriNets.FiniteStateMachines.Transition.ClassInstance)).Resolve("endState")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(FiniteStateMachinesToPetriNets.FiniteStateMachines.Transition.ClassInstance)).Resolve("startState")));
        }
