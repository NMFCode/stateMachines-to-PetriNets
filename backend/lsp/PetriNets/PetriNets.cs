...
namespace FiniteStateMachinesToPetriNets.PetriNets
{
    ...
    /// <summary>
    /// Denotes a class capable to parse the language petri-nets
    /// </summary>
        ...
        public partial class TransitionRule : ModelElementRule<Transition>
        {
            ...
            public override void Initialize(GrammarContext context)
            {
                Rules = new FormattedRule[] {
                        ...
                        RuleFormatter.ZeroOrOne(new SequenceRule(context.ResolveFormattedRule<TransitionFromPlaceRule>(FormattingInstruction.SupressSpace), RuleFormatter.ZeroOrMore(new SequenceRule(context.ResolveKeyword(","), context.ResolveFormattedRule<TransitionFromPlaceRule>(FormattingInstruction.SupressSpace))))),
                        context.ResolveKeyword("]", FormattingInstruction.Newline),
                        context.ResolveKeyword("to"),
                        context.ResolveKeyword("[", FormattingInstruction.SupressSpace),
                        RuleFormatter.ZeroOrOne(new SequenceRule(context.ResolveFormattedRule<TransitionToPlaceRule>(FormattingInstruction.SupressSpace), RuleFormatter.ZeroOrMore(new SequenceRule(context.ResolveKeyword(","), context.ResolveFormattedRule<TransitionToPlaceRule>(FormattingInstruction.SupressSpace))))),
